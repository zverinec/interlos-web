...
if(new DateTime() >= new DateTime("2014-12-06 16:30:00")) {
...
<div class="root">
	...
	<div class="contents">
		...
		<ul>
			<li><a href="P4-ukecany.c">P4-ukecany.c</a> (P4 Ukecaný program)</li>
			<li><a href="P5-snaps.zip">P5-snaps.zip</a> (P5 Velký bratr)</li>
			<li><a href="P6-input.txt">L5-rec2.mp3</a> (P6 Bludiště s pohyblivými stěnami)</li>
			<li><a href="S5.mp3">S5.mp3</a> (S5 Šifra)</li>
			<li><a href="http://interlos.yavanna.cz/sada2/eliza/">http://interlos.yavanna.cz/sada2/eliza/</a> (L6 Antiterapeutická)</li>
		</ul>
		<div class="hr">&nbsp;</div>
