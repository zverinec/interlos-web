	...
	<div class="main">
		<div class="contents" >
			<div class="main-block">
				...
				<div class="nok">
					<div class="info-time">17:24</div>
					<div class="info-message">Úloha P6: v případě stejné délky cesty, má přednost ta, která má odkazy výše (upravíme zadání a opravíme odpovědi týmů, kteří odevzdali před úpravou).</div>
				</div>
				...
				<div class="ok">
					...
					<div class="info-message">Každá úloha ze sady 1 byla vyluštěna!</div>
				</div>
				<div class="neutral">
					<div class="info-time">15:30</div>
					<div class="info-message">Povolili jsme statistiky jednotlivých úloh.</div>
				</div>
				...
				<div class="nok">
					...
					<div class="info-message">Súťaž začína 10.12.2017 o 15:00</div>
				</div>
