      ...
      <div class="main">
         <div class="contents" >
            <div class="main-block">
               ...
               <div class="ok">
                  <div class="info-time">18:06</div>
                  <div class="info-message">U všech dosavadních odevzdání L1 jsme provedli ruční kontrolu. Body jsou přepočítány.</div>
               </div>
               <div class="ok">
                  <div class="info-time">17:19</div>
                  <div class="info-message">Všechny úlohy 1. i 2. sady byly úspěšně vyřešeny alespoň jedním týmem.</div>
               </div>
               <div class="nok">
                  <div class="info-time">17:02</div>
                  <div class="info-message">P5 nekorektně vyhodnocovala správnost řešení. Vyhodnocování opraveno, odevzdání přepočítána.</div>
               </div>
               <div class="nok">
                  <div class="info-time">16:34</div>
                  <div class="info-message">Zjistili jsme, že úloha L1 má více správných řešení. Tato řešení budeme postupně uznávat. Pokud jste odevzdali (odevzdáte) řešení, o kterém jste přesvědčeni, že je správné, neodevzdávejte další řešení. Omlouváme se za potíže.</div>
               </div>
               <div class="nok">
                  <div class="info-time">15:44</div>
                  <div class="info-message">Úloha P2 obsahuje chybu v poslední větě zadání, odevzdávejte seznam cen oddělených znakem X.</div>
               </div>
               <div class="ok">
                  <div class="info-time">15:10</div>
                  <div class="info-message">První úloha pokořena, gratulujeme!</div>
               </div>
               <div class="ok">
                  <div class="info-time">14:30</div>
                  <div class="info-message">Soutěž začíná 7. 12. 2024 v 15:00. Hurá do losí školy! :).</div>
               </div>
