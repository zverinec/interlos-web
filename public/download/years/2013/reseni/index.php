...
<div class="root">
	...
	<div class="contents">
		...
		<div class="header-year"><h1>ročník 2013</h1></div>
	...
	<div class="contents">
		...
		<ul>
			<li><a href="P3-solution.cpp">P3-solution.cpp</a> (P3 LoS Mistra Leonarda)</li>
			<li><a href="P4-solution.cpp">P4-solution.cpp</a> (P4 LoS Karpální tunel)</li>
			<li><a href="P5-input.txt">P5-input.txt</a> (P5 Losí nakupování)</li>
			<li><a href="P5-knapsack.py">P5-knapsack.py</a> (P5 Losí nakupování)</li>
			<li><a href="P6-solution.hs">P6-solution.hs</a> (P6 Úloha pro maminku)</li>
			<li><a href="P7-solution.cpp">P7-solution.cpp</a> (P7 4D bludiště)</li>
			<li><a href="P8-unicode-generator.c">P8-unicode-generator.c</a> (P8 Óda na Unicode)</li>
			<li><a href="P8-unicode-solver.c">P8-unicode-solver.c</a> (P8 Óda na Unicode)</li>
			<li><a href="P9-solution.cpp">P9-solution.cpp</a> (P9 Palindromy)</li>
		</ul>
		<div class="hr">&nbsp;</div>
