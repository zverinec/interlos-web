...
if(new DateTime() >= new DateTime("2013-11-30 18:00:00")) {
...
<div class="root">
    ...
    <div class="contents">
        ...
        <ul>
            <li><a href="http://interlos.yavanna.cz/tanky/">interlos.yavanna.cz/tanky/</a> (L9 Think or Die)</li>
            <li><a href="P7-bludiste.txt">P7-bludiste.txt</a> (P7 4D bludiště)</li>
            <li><a href="P8-zadani.txt">P8-zadani.txt</a> (P8 Óda na Unicode)</li>
            <li><a href="P9-palindromy.txt">P9-palindromy.txt</a> (P9 Palindromy)</li>
        </ul>
        <div class="hr">&nbsp;</div>
