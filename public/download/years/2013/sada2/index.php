...
if(new DateTime() >= new DateTime("2013-11-30 16:30:00")) {
        @rename(".htaccess",'.htaccess-old');
} else {
        die('Druha sada bude zpristupnena az v 16:30.');
}
?>
...
<head>
  ...
  <title>2. sada &ndash; INTERnetová LOgická SOutěž</title>
</head>
<div class="root">
    <div class="header">
    ...
    <div class="contents">
        ...
        <ul>
            <li><a href="L5-desc.mp3">L5-desc.mp3</a> (L5 Deterministický les)</li>
            <li><a href="L5-rec1.mp3">L5-rec1.mp3</a> (L5 Deterministický les)</li>
            <li><a href="L5-rec2.mp3">L5-rec2.mp3</a> (L5 Deterministický les)</li>
            <li><a href="L5-rec3.mp3">L5-rec3.mp3</a> (L5 Deterministický les)</li>
            <li><a href="S6-code.c">S6-code.c</a> (S6 Programátorská šifra)</li>
        </ul>
        <div class="hr">&nbsp;</div>
